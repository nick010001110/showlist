...
import { setShowsAC_T,setGenresAC_T,setLanguagesAC_T,setCurrentPageAC_T,setCurrentLanguagesAC_T, setCurrentGenresAC_T, setPageCountAC_T, setQueryAC_T ,setYearsAC_T, setCountriesAC_T, setСurrentCountriesAC_T} from '../reducers/rootReducer';
