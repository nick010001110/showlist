...
const Trending = (props) => {
    ...
    useEffect ( () =>{
        ...
        async function didMount (){
            ...
            const response = await axios({
                url: `https://api.trakt.tv/shows/trending?page=${data.currentPage}&limit=${data.pageLimit}&genres=${data.currentGenres}&languages=${data.currentLanguages}&query=${data.query}&years=${data.years}&countries=${data.currentCountries}`,
                method: 'get',
                headers: {
    ...
    const onPageChanged=(pageNumber)=>{
        ...
        async function changePage (pageNumber){
            ...
            const response = await axios({
                url: `https://api.trakt.tv/shows/trending?page=${pageNumber}&limit=${data.pageLimit}&genres=${data.currentGenres}&languages=${data.currentLanguages}&query=${data.query}&years=${data.years}&countries=${data.currentCountries}`,
                method: 'get',
                headers: {
                    'Content-Type': process.env.REACT_APP_CONTENT_TYPE,
                    'trakt-api-version': process.env.REACT_APP_TRAKT_API_VERSION,
    ...
    const onLangComboboxChange=(value)=>{
        ...
        async function pageChange(data){
            const response = await axios({
                url: `https://api.trakt.tv/shows/trending?page=${1}&limit=${data.pageLimit}&genres=${data.currentGenres}&languages=${res.join()}&query=${data.query}&years=${data.years}&countries=${data.currentCountries}`,
                method: 'get',
                headers: {
                    'Content-Type': process.env.REACT_APP_CONTENT_TYPE,
                    'trakt-api-version': process.env.REACT_APP_TRAKT_API_VERSION,
    ...
    const onGenreComboboxChange=(value)=>{
        ...
        async function pageChange(data){
            const response = await axios({
                url: `https://api.trakt.tv/shows/trending?page=${1}&limit=${data.pageLimit}&genres=${res.join()}&languages=${data.currentLanguages}&query=${data.query}&years=${data.years}&countries=${data.currentCountries}`,
                method: 'get',
                headers: {
    ...
    const onCountriesComboboxChange=(value)=>{
        ...
        async function pageChange(data){
            const response = await axios({
                url: `https://api.trakt.tv/shows/trending?page=${1}&limit=${data.pageLimit}&genres=${data.currentGenres}&languages=${data.currentLanguages}&query=${data.query}&years=${data.years}&countries=${res.join()}`,
                method: 'get',
                headers: {
                    'Content-Type': process.env.REACT_APP_CONTENT_TYPE,
                    'trakt-api-version': process.env.REACT_APP_TRAKT_API_VERSION,
    ...
    const handleChangeQuery=(e)=>{
        ...
        async function pageChange(data){
            const response = await axios({
                url: `https://api.trakt.tv/shows/trending?page=${1}&limit=${data.pageLimit}&genres=${data.currentGenres}&languages=${data.currentLanguages}&query=${e.target.value}&years=${data.years}&countries=${data.currentCountries}`,
                method: 'get',
                headers: {
                    'Content-Type': process.env.REACT_APP_CONTENT_TYPE,
                    'trakt-api-version': process.env.REACT_APP_TRAKT_API_VERSION,
    ...
    const handleChangeYears=(e)=>{
        ...
        async function pageChange(data){
            const response = await axios({
                url: `https://api.trakt.tv/shows/trending?page=${1}&limit=${data.pageLimit}&genres=${data.currentGenres}&languages=${data.currentLanguages}&query=${data.query}&years=${e.target.value}&countries=${data.currentCountries}`,
                method: 'get',
                headers: {
                    'Content-Type': process.env.REACT_APP_CONTENT_TYPE,
                    'trakt-api-version': process.env.REACT_APP_TRAKT_API_VERSION,
